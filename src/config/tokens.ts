...
/**
 * The eligible symbols, in the order published by the organizers — with three edits:
 * GRAM added as TON's CoinMarketCap alias (Toncoin was renamed "Gram"/GRAM), and H + IP
 * dropped (neither has a real BSC deployment, so a live buy can't route).
 */
